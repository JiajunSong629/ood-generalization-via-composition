...
# file_path = os.path.join(current_dir, "IH_scores_gemma_7b_it_1000.json")
...
# file_path = os.path.join(current_dir, "IH_gemma_7b.json")
file_path = os.path.join(current_dir, "IH_gemma2_9b.json")
def get_top_layer_head_ids_gemma(scale = "7b", num_heads = 200, file_path = file_path):
