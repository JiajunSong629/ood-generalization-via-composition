...
# file_path = os.path.join(current_dir, "IH_scores_falcon_7b_1000.json")
# file_path = os.path.join(current_dir, "IH_scores_falcon_11B_1000.json")
...
# file_path = os.path.join(current_dir, "IH_falcon_7b.json")
file_path = os.path.join(current_dir, "IH_falcon2_11b.json")
def get_top_layer_head_ids_gemma(scale = "7b", num_heads = 200, file_path = file_path):
