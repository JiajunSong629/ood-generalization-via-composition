...
REMOVAL_CONFIGS = {
    ...
    "gpt2": {"n_heads": [0, 50]},
    "gpt2-xl": {"n_heads": [0, 50]},
    "llama2-7b": {"n_heads": [0, 50]},
    "llama3-8b": {"n_heads": [0, 50]},
    "gemma-7b": {"n_heads": [0, 50]},
    "gemma2-9b": {"n_heads": [0, 50]},
    "falcon-7b": {"n_heads": [0, 50]},
    "mistral-7b": {"n_heads": [0, 50]},
    "olmo-7b": {"n_heads": [0, 50]},
    # pythia models
