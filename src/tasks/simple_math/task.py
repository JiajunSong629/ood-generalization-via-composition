...
from src.tasks.simple_math.template import generate_task_with_context
...
class SimpleMathTask(task.Task):
    def __init__(
        self,
    ...
    def evaluate_model(
        ...
        # batch_size = 8 if model.model_meta["model_name"].startswith("gpt2") else 1
        ...
        result = result_api.SimpleMathResult(
